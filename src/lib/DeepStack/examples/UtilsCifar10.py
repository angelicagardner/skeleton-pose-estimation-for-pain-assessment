...
from src.utils.DeepStack.deepstack.base import KerasMember
from src.utils.DeepStack.deepstack.ensemble import DirichletEnsemble
from src.utils.DeepStack.deepstack.ensemble import StackEnsemble
...
def get_random_cifar_model(batch_size=32, epochs=2):
    """
